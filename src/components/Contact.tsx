      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
            We'd love to see you in person. Stop by for a coffee or reach out to us with any questions.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-100 rounded-lg p-8 h-full">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-600 hover:text-amber-800">
          ...
          <div>
            <form className="bg-gray-100 rounded-lg p-8">
